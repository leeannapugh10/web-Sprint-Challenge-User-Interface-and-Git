...
I would say that semantic HTML is extremely important to understand so you can correctly lay out a webpage.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Height and width are not effected with inline.  Block doesn't force a line break.
...
It has a full history for each member of the team to see what has been done in the past.  It is also easy for everyone to make branches and folders.
